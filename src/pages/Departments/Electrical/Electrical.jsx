...
const Electrical = () => {
  ...
  const courses = [
    { code: "DEEP", title: "Electrical Engineering (Power Option) Level 6",level: "Level 6",department: "Electrical Engineering", requirement: "C- or Pass in Level 5", duration: "9 Terms", examBody: "CDACC" },
    { code: "CEEP", title: "Electrical Engineering (Power Option) Level 5",level: "Level 6",department: "Electrical Engineering", requirement: "D- or Pass in Level 4", duration: "6 Terms", examBody: "CDACC" },
    { code: "AIE", title: "Electrical Installation",level: "Level 4",department: "Electrical Engineering", requirement: "Grade D – and E", duration: "3 Terms", examBody: "CDACC" },
  ];
  ...
  return (
    <>
      ...
      <section className="hero">
        <img src={Photo} alt="Electrical Engineering Department" />
        <div className="hero-overlay">
          <h1>Electrical Engineering</h1>
          <p>Training Skilled Professionals in Electrical Power & Installation</p>
        </div>
      </section>
