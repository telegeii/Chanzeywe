...
import {
  FaChevronRight, FaBolt, FaClock, FaBook,
  FaUserGraduate, FaMoneyBillWave, FaIdCard,
  FaCamera, FaFileAlt, FaCalendarAlt,
} from "react-icons/fa";
...
const Electrical = () => {
  ...
  useEffect(() => {
    apiGet("/departments.php?slug=electrical")
      .then(setDepartment)
  ...
  useSeo({
    title: department ? `${department.name} Department` : "Electrical Engineering Department",
    description: department?.tagline || "Electrical Engineering courses at Chanzeywe Vocational Training College, Vihiga, Kenya — CDACC-accredited power and installation diploma, certificate and artisan programmes.",
  });
      ...
      {activeTab === "courses" && (
        <section className="cmp-courses">
          <div className="cmp-courses__header">
            ...
            <p>CDACC-accredited electrical programmes for power and installation careers.</p>
          </div>
