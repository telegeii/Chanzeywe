      ...
      <section className="cmp-hero">
        ...
        <div className="cmp-hero__content">
          <span className="cmp-hero__eyebrow">
            <FaBolt /> Electrical Engineering
          </span>
          <h1>Training Skilled Professionals in Electrical Power &amp; Installation</h1>
          <p>Industry-aligned programmes powering Kenya's electrical and energy sectors.</p>
