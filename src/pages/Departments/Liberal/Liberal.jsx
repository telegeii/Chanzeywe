      ...
      <section className="cmp-hero">
        ...
        <div className="cmp-hero__content">
          <span className="cmp-hero__eyebrow">
            <FaUsers /> Liberal Studies
          </span>
          <h1>Empowering Social &amp; Management Professionals</h1>
          <p>Programmes in social work and supply chain management for community impact.</p>
          <div className="cmp-hero__breadcrumb">
            <Link to="/">Home</Link>
            <FaChevronRight />
            <Link to="/courses">Departments</Link>
            <FaChevronRight />
            <span>Liberal Studies</span>
          </div>
        </div>
      </section>
