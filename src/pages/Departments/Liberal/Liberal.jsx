...
import {
  FaChevronRight, FaUsers, FaClock, FaBook,
...
const Liberal = () => {
  ...
  useEffect(() => {
    apiGet("/departments.php?slug=liberal")
      .then(setDepartment)
  ...
  useSeo({
    title: department ? `${department.name} Department` : "Liberal Studies Department",
    description: department?.tagline || "Liberal Studies courses at Chanzeywe Vocational Training College, Vihiga, Kenya — social work and supply chain management diploma and certificate programmes.",
  });
      ...
      {activeTab === "courses" && (
        <section className="cmp-courses">
          <div className="cmp-courses__header">
            ...
            <p>CDACC-accredited social and management programmes for community leaders.</p>
          </div>
